...
# ================================================#
notmine = f"This is {OWNER_NAME} Assistant"

TLINK = "https://i.ibb.co/6P0yyxJ/photo-2021-09-13-11-46-57.jpg"
...
SUP_BUTTONS = [
    [
        Button.url("Subscribe The Channel", url="https://www.youtube.com/channel/UC5CwaMl1eIgY8h02uZw7u8A"),
    ],
]
...
async def inline_alive(o):
    if len(o.text) == 0:
        b = o.builder
        MSG = "Suisei Assistant"
        WEB0 = InputWebDocument(
            "https://i.ibb.co/3NZWCH1/photo-2021-08-23-01-11-10.jpg", 0, "image/jpg", []
        )
        RES = [
            InputBotInlineResult(
                ...
                title="Suisei Assistant",
                description="Assistnt bot that make yourlife better",
                url=TLINK,
                thumb=WEB0,
                content=InputWebDocument(TLINK, 0, "image/jpg", []),
            )
        ]
        await o.answer(RES, switch_pm="", switch_pm_param="start")
